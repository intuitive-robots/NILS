...
class Visualizer:
    ...
    def draw_binary_mask_with_box(self,bbox,color=None, *, edge_color=None, text=None, label_mode='1', alpha=0.7, anno_mode=['Mask'],
            area_threshold=10):
    ...
    def _draw_number_in_mask(self, binary_mask, text, color, label_mode='1'):
        ...
        self.draw_text(text, (coords_x[len(coords_x) // 2] + 2, coords_y[len(coords_y) // 2] + 10), color=color)
